...
class HeaderDropdown extends Component {
  static displayName = 'HeaderDropdown'
    ...
    return (
      <Dropdown nav isOpen={this.state.dropdownOpen} toggle={this.toggle}>
        ...
        <DropdownMenu right>
          ...
          {/*<DropdownItem><i className="fa fa-address-card-o"></i> Company Address</DropdownItem>*/}
          {/*<DropdownItem><i className="fa fa-list"></i> Company Sepa</DropdownItem>*/}
          {/*<DropdownItem><i className="fa fa-file"></i> SMTP Setting</DropdownItem>*/}
          {/*<DropdownItem divider/>*/}
          {/*<DropdownItem><i className="fa fa-shield"></i> Lock Account</DropdownItem>*/}
          <DropdownItem onClick={(e) => this.changeLanguage("en")}><i className="fa fa-language"></i> <Trans i18nKey="header.english"/></DropdownItem>
          {/*<DropdownItem onClick={(e) => this.changeLanguage("gm")}><i className="fa fa-language"></i> <Trans i18nKey="header.german"/></DropdownItem>*/}
          <DropdownItem onClick={(e) => this.changeLanguage("gm")}><i className="fa fa-language"></i> {t("header.german")}</DropdownItem>
          <DropdownItem onClick={(e) => this.logout(e)}><i className="fa fa-lock"></i> <Trans i18nKey="common.logout"/></DropdownItem>
        </DropdownMenu>
      </Dropdown>
    );
  }
...
export default connect(mapStateToProps, mapDispatchToProps) (withTranslation()(HeaderDropdown));
