  ...
  render() {
    ...
    if (_.isEmpty(selected)) {
      return (<div className="lhtml-style">
        <h5 className="text-center" style={{ paddingTop: '36px', paddingBottom: '36px', margin: 0 }}><Trans i18nKey="calendars.non_selected"/></h5>
      </div>)
    } else {
      return (<div className="lhtml-style">
...
export default connect(mapStateToProps, mapDispatchToProps)(withTranslation()(LHtmlStyle));