...
const displayName = 'AddNewLicenseForm';
const propTypes = {
  ...
  function renderBody() {
    return (
      <CardBody className="p-4">
        <h1><Trans i18nKey="admin.create_license_model"/></h1>
        <p className="text-muted"><Trans i18nKey="admin.create_license_model_description"/></p>
        <FormGroup row>
          <Col md="3">
        ...
        <Button type="submit" color="success" block style={{ width: 150, float: "right" }}><Trans i18nKey="admin.store_license"/></Button>
      </CardBody>
    )
  }
